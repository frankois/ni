...
# Embedded file name: /Applications/Ableton Live 11 Suite.app/Contents/App-Resources/MIDI Remote Scripts/Maschine_Studio/MaschineSessionComponent.py
                ...
                if clip_slot:
                    ...
                    if clip_slot.has_clip:
                        if clip_slot.clip.is_recording or clip_slot.clip.will_record_on_start:
                            ...
                            if clip_slot.clip.is_triggered:
                                button.send_color_direct(color[int(sblink)])
                            else:
                                if clip_slot.clip.is_playing:
...
# okay decompiling src/MaschineSessionComponent.pyc
