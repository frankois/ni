...
# Embedded file name: /Applications/Ableton Live 11 Suite.app/Contents/App-Resources/MIDI Remote Scripts/Maschine_Mk2/KnobSection.py
# Compiled at: 2021-04-30 12:04:50
# Size of source mod 2**32: 17060 bytes
import Live
...
class KnobSection(CompoundComponent):
    ...
    def enter_toggle_mode(self, mode=None):
        ...
        self.alt_mode = False
        if self._mode < KSM_SCROLL or mode is not None:
            if mode is None:
                self.switch_pad_wheel_edit(False)
    ...
    def refresh(self):
        pass
# okay decompiling src/KnobSection.pyc
