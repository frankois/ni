...
# Embedded file name: /Applications/Ableton Live 11 Suite.app/Contents/App-Resources/MIDI Remote Scripts/Maschine_Studio/PadMode.py
# Compiled at: 2021-04-30 12:12:38
# Size of source mod 2**32: 13973 bytes
import Live
...
class PadMode(MaschineMode):
    ...
    def enter_clear_state(self):
        ...
        cs = self.song().view.highlighted_clip_slot
        in_notes = set()
        if cs is not None and cs.has_clip and cs.clip.is_midi_clip:
            clip = cs.clip
