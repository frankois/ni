...
# Embedded file name: /Applications/Ableton Live 11 Suite.app/Contents/App-Resources/MIDI Remote Scripts/Maschine_Mk2/MidiEditSection.py
# Compiled at: 2021-04-30 12:04:50
# Size of source mod 2**32: 12479 bytes
import Live
            ...
            if clip_slot:
                if clip_slot.has_clip:
                    if clip_slot.clip.is_midi_clip:
                        ...
                        self._note_set = clip.get_notes_extended(0, 127, 0.0, clip.length)
                        ...
                        ls.append(selnote)
                        clip.remove_notes_extended(selnote[0], 1, selnote[1], selnote[2])
