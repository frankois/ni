...
# Embedded file name: /Applications/Ableton Live 11 Suite.app/Contents/App-Resources/MIDI Remote Scripts/Maschine_Mikro_Mk2/NoteRepeatComponent.py
        ...
        if value != 0:
            ...
            if self._hold_mode:
                if self._previous_button == button:
                    ...
                    if self._previous_button == None or self._previous_button != button:
    ...
    def _do_note_repeat(self, value):
        ...
        if self._hold_mode:
            if value > 0:
                ...
                self._hold_mode = False
                if self._previous_button == None:
                    if self._last_active_button != None:
