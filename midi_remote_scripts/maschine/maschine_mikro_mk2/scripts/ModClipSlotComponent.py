...
# Embedded file name: /Applications/Ableton Live 11 Suite.app/Contents/App-Resources/MIDI Remote Scripts/Maschine_Mikro_Mk2/ModClipSlotComponent.py
    ...
    def _launch_button_value(self, value):
        if self.is_enabled():
            if self._modifier and self._modifier.hasModification(CLIP_MODE):
                ...
                if self._clip_slot != None and self._modifier and self._modifier.isShiftdown() and value != 0:
