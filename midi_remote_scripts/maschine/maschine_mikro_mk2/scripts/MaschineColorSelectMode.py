...
# Embedded file name: /Applications/Ableton Live 11 Suite.app/Contents/App-Resources/MIDI Remote Scripts/Maschine_Mikro_Mk2/MaschineColorSelectMode.py
...
BASE_COLOR_TABLE = ((115, 127, 127, 16726484), (124, 73, 127, 15810688), (3, 127, 118, 15549221),
                    ...
                    (24, 118, 110, 14939139))
BASE_COLOR_TABLE_2 = ((0, 127, 127, 16712965), (9, 125, 123, 16149507), (12, 107, 127, 16753961),
...
class MaschineColorSelectMode(MaschineMode):
    ...
    def exit(self):
        self._active = False
        self._release()
# okay decompiling src/MaschineColorSelectMode.pyc
