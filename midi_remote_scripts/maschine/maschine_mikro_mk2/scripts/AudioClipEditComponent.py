...
# Embedded file name: /Applications/Ableton Live 11 Suite.app/Contents/App-Resources/MIDI Remote Scripts/Maschine_Mikro_Mk2/AudioClipEditComponent.py
# Compiled at: 2021-04-30 12:09:45
# Size of source mod 2**32: 13037 bytes
import Live
    ...
    def _on_gain_changed(self):
        ...
        if cs:
            if cs.has_clip:
                if cs.clip.is_audio_clip:
                    self._gain_slider.send_value(gain_to_midi(cs.clip.gain))
# okay decompiling src/AudioClipEditComponent.pyc
