...
# Embedded file name: /Applications/Ableton Live 11 Suite.app/Contents/App-Resources/MIDI Remote Scripts/Maschine_Mikro_Mk2/MIDI_Map.py
# Compiled at: 2021-04-30 12:09:45
# Size of source mod 2**32: 12241 bytes
import Live, re
...
def toHSB(rgb_val):
    ...
    color = (
     (
      hue / 2, min(sat / 2 + 20, 127), bright / 2), (hue / 2, min(sat / 2 + 15, 127), max(bright / 2 - 90, 5)))
    _color_table[rgb_val] = color
    return color
...
PAD_TRANSLATIONS = ((0, 0, 24, 0), (1, 0, 25, 0), (2, 0, 26, 0), (3, 0, 27, 0), (0, 1, 20, 0),
                    (1, 1, 21, 0), (2, 1, 22, 0), (3, 1, 23, 0), (0, 2, 16, 0), (1, 2, 17, 0),
                    (2, 2, 18, 0), (3, 2, 19, 0), (0, 3, 12, 0), (1, 3, 13, 0), (2, 3, 14, 0),
                    (3, 3, 15, 0))
...
def device_get_mode_color(mode, ind):
    ...
    return
# okay decompiling src/MIDI_Map.pyc
